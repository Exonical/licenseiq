...
func truncateAll(t *testing.T, db *gorm.DB) {
	t.Helper()
	if err := db.Exec(`TRUNCATE TABLE feature_flag_audits, feature_flags, audit_logs, api_keys, users, attachments, assignments, licenses, products, vendor_contacts, vendors RESTART IDENTITY CASCADE`).Error; err != nil {
